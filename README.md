...
{'likelihood':
   {'Likelihood_inflate_class.PlikLiteTT650':
      {'python_path': 'where_you_copy_this_repository/Python',
       'data_folder': 'where_you_copy_this_repository/Data'
      }}}
...
```
